    ...
    function _class(props) {
      ...
      _this.handleSortEnd = function (e) {
        ...
        if (transitionDuration) {
          _this.helper.style[vendorPrefix + 'TransitionDuration'] = transitionDuration + 'ms';

          var helperStart = _this.helper.getBoundingClientRect();
          var helperDestination = _this.sortableGhost.getBoundingClientRect();
          _this.helper.style[vendorPrefix + 'Transform'] = 'translate3d(' + (helperDestination.left - (helperStart.left - _this.translate.x)) + 'px,' + (helperDestination.top - (helperStart.top - _this.translate.y)) + 'px,0)';
        }
        ...
        setTimeout(function (helper) {
          if (_this.props.hideSortableGhost && _this.sortableGhost) {
            _this.sortableGhost.style[vendorPrefix + 'Transform'] = '';
            _this.sortableGhost.style[vendorPrefix + 'TransitionDuration'] = '';
    ...
    _createClass(_class, [{
      ...
      value: function animateNodes() {
        ...
        if (this.sortableGhost) {
          this.sortableGhost.style[vendorPrefix + 'Transform'] = 'translate3d(' + ghostTranslate.x + 'px,' + ghostTranslate.y + 'px,0)';
        }
      }
    }, {
